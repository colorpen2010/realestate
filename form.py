...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.address_line = QLineEdit(Form)
        self.address_line.setObjectName(u"address_line")
        self.address_line.setGeometry(QRect(280, 100, 113, 22))
        self.label = QLabel(Form)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(280, 80, 49, 16))
        self.rb_residence = QRadioButton(Form)
        self.rb_residence.setObjectName(u"rb_residence")
        self.rb_residence.setGeometry(QRect(300, 10, 89, 20))
        self.rb_residence.setChecked(True)
        self.rb_commercial = QRadioButton(Form)
        self.rb_commercial.setObjectName(u"rb_commercial")
        self.rb_commercial.setGeometry(QRect(300, 40, 89, 20))
        ...
        self.price_line.setGeometry(QRect(280, 140, 113, 22))
        self.descruption = QTextBrowser(Form)
        self.descruption.setObjectName(u"descruption")
        self.descruption.setGeometry(QRect(10, 20, 256, 192))
        self.descruption.setReadOnly(False)
    ...
    def retranslateUi(self, Form):
        ...
        self.rb_residence.setText(QCoreApplication.translate("Form", u"\u0416\u0438\u043b\u043e\u0435", None))
        self.rb_commercial.setText(QCoreApplication.translate("Form", u"\u041a\u043e\u043c\u043c\u0435\u0440\u0446\u0438\u044f", None))
